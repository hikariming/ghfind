/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=RuntimeEnv` (hash: d7157084f12212921e5e8746d66b6553)
// Runtime types generated with workerd@1.20260907.1 2026-09-08 nodejs_compat
interface __BaseEnv_RuntimeEnv {
	FEED_JOBS_QUEUE: Queue;
	WORKER_VERSION: WorkerVersionMetadata;
	FEED_ENVIRONMENT: string;
	FEED_RELEASE_SHA: string;
	FEED_IMAGE_REFERENCE: string;
	FEED_MODE: string;
	FEED_WRITER_EPOCH: string;
	FEED_EXECUTOR_ENABLED: string;
	FEED_SOURCE_RELAY_ENABLED: string;
	FEED_QUEUE_NAME: string;
	FEED_DLQ_NAME: string;
	FEED_GATEWAY_SECRET: string;
	FEED_SIGNING_SECRET: string;
	FEED_BRIDGE_SECRET: string;
	FEED_RUNTIME_ADMIN_SECRET: string;
	FEED_EXECUTOR_SECRET: string;
	FEED_SOURCE_SECRET: string;
	FEED_DELIVERY_SECRET: string;
	FEED_API: DurableObjectNamespace<import("./src/index").FeedAPI>;
	FEED_EXECUTOR: DurableObjectNamespace<import("./src/index").FeedExecutor>;
	FEED_ADAPTER: Fetcher /* ghfind-feed-adapter-unconfigured */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FeedAPI" | "FeedExecutor";
	}
	interface Env extends __BaseEnv_RuntimeEnv {}
}
interface RuntimeEnv extends __BaseEnv_RuntimeEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FEED_ENVIRONMENT" | "FEED_RELEASE_SHA" | "FEED_IMAGE_REFERENCE" | "FEED_MODE" | "FEED_WRITER_EPOCH" | "FEED_EXECUTOR_ENABLED" | "FEED_SOURCE_RELAY_ENABLED" | "FEED_QUEUE_NAME" | "FEED_DLQ_NAME" | "FEED_GATEWAY_SECRET" | "FEED_SIGNING_SECRET" | "FEED_BRIDGE_SECRET" | "FEED_RUNTIME_ADMIN_SECRET" | "FEED_EXECUTOR_SECRET" | "FEED_SOURCE_SECRET" | "FEED_DELIVERY_SECRET">> {}
}
