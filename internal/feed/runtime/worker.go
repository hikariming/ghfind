...
type WorkerConfig struct {
	Config
	Enabled                                                                       bool
	ExecutorSecret, SourceEndpoint, SourceSecret, CleanupEndpoint, OperatorSecret string
...
func LoadWorkerConfig() (WorkerConfig, error) {
	...
	out := WorkerConfig{Config: c, Enabled: os.Getenv("FEED_EXECUTOR_ENABLED") == "true", ExecutorSecret: os.Getenv("FEED_EXECUTOR_SECRET"), SourceEndpoint: os.Getenv("FEED_SOURCE_ENDPOINT"), SourceSecret: os.Getenv("FEED_SOURCE_SECRET"), CleanupEndpoint: os.Getenv("FEED_CLEANUP_ENDPOINT"), OperatorSecret: os.Getenv("FEED_OPERATOR_SECRET")}
