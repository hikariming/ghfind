...
func TestRoastCachePreservesNodeKeysTTLAndLockLifetime(t *testing.T) {
	...
	assertCommandString(t, setCache, 1, "roast:v11:v10:v4:en:octocat")
	assertCommandNumber(t, setCache, 4, 172800)
	assertCommandString(t, setLock, 0, "SET")
	assertCommandString(t, setLock, 1, "lock:roast:v11:v10:v4:en:octocat")
	assertCommandNumber(t, setLock, 5, 270)
	assertCommandString(t, clearCache, 0, "DEL")
	assertCommandString(t, clearCache, 1, "roast:v11:v10:v4:en:octocat")
}
