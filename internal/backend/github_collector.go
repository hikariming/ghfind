...
func (c *GitHubCollector) Collect(ctx context.Context, username string) (ScanResult, error) {
	...
	return ScanResult{Metrics: metrics, TopRepos: topRepos, RecentPRs: recentPRs, FloodPRTitles: flood.FloodPRTitles, ImpactRepos: impact.ImpactRepos, VerifiedImpactPRs: verifiedImpact, SignatureWork: BuildRecentSignatureWork(impact.ImpactRepos, recentPRs), PinnedRepos: overview.PinnedRepos, Organizations: organizations, Scoring: Score(metrics)}, nil
}
